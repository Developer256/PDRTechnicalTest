...
namespace PDR.PatientBookingApi.Controllers
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        public IActionResult AddBooking(NewBooking newBooking)
        {
            ...
            if (bookingStartTime < DateTime.Now || bookingEndTime < DateTime.Now || existingOrder != null) validBooking = false;
        ...
        public IActionResult CancelBooking(Guid id)
        {
            ...
            existingOrder = _context.Order.FirstOrDefault(booking => booking.Id == id);
